...
curl -X POST http://localhost:8080/api/v1/drones ^
  ...
  -s > artefatos\drone-log\drone1.json
echo Drone 1 criado
echo.
...
curl -X POST http://localhost:8080/api/v1/drones ^
  ...
  -s > artefatos\drone-log\drone2.json
echo Drone 2 criado
echo.
...
curl -X POST http://localhost:8080/api/v1/drones ^
  ...
  -s > artefatos\drone-log\drone3.json
echo Drone 3 criado
echo.
...
curl -X POST http://localhost:8080/api/v1/pedidos ^
  ...
  -s > artefatos\pedidos-log\pedido1.json
...
curl -X POST http://localhost:8080/api/v1/pedidos ^
  ...
  -s > artefatos\pedidos-log\pedido2.json
...
curl -X POST http://localhost:8080/api/v1/pedidos ^
  ...
  -s > artefatos\pedidos-log\pedido3.json
...
curl -X POST http://localhost:8080/api/v1/drones/fly ^
  -s > artefatos\voos-log\voo_iniciado.json
